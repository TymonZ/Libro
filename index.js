...
const { backup2GoogleDrive } = require("./js/cloud-sync/backup2GoogleDrive")
...
// Connect with gdrive, then do callback function
googleDriveSetup((auth) =>{ //auth is used in 'backup files' function
